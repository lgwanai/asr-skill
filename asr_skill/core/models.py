...
The pipeline combines three models:
...
def create_pipeline(device: str, model_dir: str = MODEL_DIR) -> AutoModel:
    """Create FunASR pipeline with VAD + ASR + Punctuation composition.
